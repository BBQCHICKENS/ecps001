...
<script>
    $(function () {
        $('#updateBrand').onclick(function () {
              alert(1);
        })
    })
    function singleDel(brandId) {
        if (confirm("确定要删除此条信息")) {
            location.href = "${path}/brand/deleteBrand.do?brandId=" + brandId;
        }
    }
</script>
<div class="frameR">
    <div class="content">
        ...
        <span class="r inb_a">
            <a href="${path }/brand/toSaveBrand.do" title="添加" class="btn80x20">添加</a>
        </span>
            </div>
            ...
            <table cellspacing="0" summary="" class="tab">
                ...
                <c:forEach items="${ebBrands}" var="brand">
                    <tr>
                        ...
                        <td>
                            <a  href="${path}/brand/toEbBrand.do">编辑</a>
