...
<head>
    ...
    <script type="text/javascript" src="<c:url value='${path}/ecps/console/res/js/item/addbrand.js'/>"></script>
</head>
<body id="main">
<div class="frameL">
    <div class="menu icon">
...
<div class="frameR">
    <div class="content">
        ...
        <div class="loc icon"><samp class="t12"></samp>当前位置：商品管理&nbsp;&raquo;&nbsp;<a
            ...
            <a href="<c:url value="${path}/brand/toEbBrand.do"/>" title="返回品牌管理"
               class="inb btn80x20">返回品牌管理</a>
        </div>
        <form id="form111" name="form111" action="${path}/brand/saveBrand.do" method="post"
            ...
            <div class="edit set">
                ...
                <p><label></label><input type='file' size='27' id='imgsFile' name='imgsFile' class="file"
                    ...
                    <input type='hidden' id='lastRealPath' value=''/>
                    <span></span>
                </p>
